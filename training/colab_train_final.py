...
!rm -rf mahjong-dataset  # Clean up if exists
!git clone https://github.com/Camerash/mahjong-dataset.git
print("✅ Dataset downloaded!")

# Check what's in tiles-resized
print("\n🔍 Checking tiles-resized directory...")
!ls mahjong-dataset/tiles-resized/ | head -20

# Extract train.zip which has the organized structure
print("\n📦 Extracting organized training data...")
!unzip -q mahjong-dataset/train.zip -d mahjong-dataset/
print("✅ Extracted!")

# Check what we got
print("\n📂 Checking extracted structure...")
!ls mahjong-dataset/images/ | head -20
...
BATCH_SIZE = 32
EPOCHS = 50
DATA_DIR = './mahjong-dataset/images/'
