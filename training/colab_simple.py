...
# Download a pre-organized mahjong dataset
print("\n📥 Downloading pre-organized mahjong dataset...")
!wget -q https://github.com/Camerash/mahjong-dataset/releases/download/v1.0/tiles-organized.zip
!unzip -q tiles-organized.zip
print("✅ Dataset downloaded!")

# If that doesn't work, create a simple synthetic dataset for testing
import os
if not os.path.exists('tiles-organized'):
    print("\n⚠️  Download failed. Creating synthetic dataset for testing...")
    print("   (This won't be accurate, but will let you test the pipeline)")
    
    # Create a minimal dataset structure
    !mkdir -p synthetic_tiles
    
    # Download some sample images from a public source
    tile_types = ['1m', '2m', '3m', '1p', '2p', '3p', '1s', '2s', '3s', 
                  'east', 'south', 'west', 'north', 'red', 'green', 'white']
    
    for tile in tile_types:
        !mkdir -p synthetic_tiles/{tile}
        # Create some dummy images (you'd replace this with real images)
        for i in range(10):
            !wget -q -O synthetic_tiles/{tile}/img_{i}.jpg https://via.placeholder.com/150
    
    DATA_DIR = './synthetic_tiles/'
    print("✅ Synthetic dataset created")
else:
    DATA_DIR = './tiles-organized/'
...
print(f"\n✅ Found {len(classes)} tile classes")
